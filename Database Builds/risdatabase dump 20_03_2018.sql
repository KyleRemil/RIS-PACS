...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 21, 2018 at 04:04 AM
...
INSERT INTO `procedurelist` (`procedureId`, `staffID_technician`, `modalityProcedureTypeId`, `patient_patientID`, `procedureScheduledTime`, `procedureScheduledDate`, `procedureStatusID`, `physicianNotes`, `procedureDateOfRequest`) VALUES
(1, 4, 6, 3, NULL, NULL, 0, 'Test', '2018-03-15 00:00:00'),
(2, 3, 1, 3, NULL, NULL, 0, 'Test2', '2018-03-15 00:00:00');
...
ALTER TABLE `procedurelist`
  ADD PRIMARY KEY (`procedureId`,`staffID_technician`,`modalityProcedureTypeId`,`patient_patientID`,`procedureStatusID`),
  ...
  ADD KEY `fk_procedure_procedureStatus1_idx` (`procedureStatusID`);
...
--
ALTER TABLE `report`
  ADD PRIMARY KEY (`reportID`,`procedure_procedureId`,`staffid_Radiologist`,`staffid_RefferingMD`),
  ADD KEY `fk_report_procedure1_idx` (`procedure_procedureId`),
  ADD KEY `fk_report_staff1_idx` (`staffid_Radiologist`),
  ADD KEY `fk_report_staff2_idx` (`staffid_RefferingMD`);
...
--
ALTER TABLE `modalityimage`
  MODIFY `modalityImageID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `modalityproceduretype`
--
ALTER TABLE `modalityproceduretype`
  MODIFY `modalityProcedureTypeId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `procedurelist`
  MODIFY `procedureId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `procedurelist`
  ...
  ADD CONSTRAINT `fk_procedure_procedureStatus1` FOREIGN KEY (`procedureStatusID`) REFERENCES `procedurestatus` (`procedureStatusID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `report`
  ...
  ADD CONSTRAINT `fk_report_staff2` FOREIGN KEY (`staffid_RefferingMD`) REFERENCES `staff` (`staffID`) ON DELETE CASCADE ON UPDATE CASCADE;
